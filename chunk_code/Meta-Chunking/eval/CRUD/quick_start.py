...
parser.add_argument('--output_dir', default='./output', help="Directory for QA result JSON files")
...
elif args.model_name == "qwen_api":
    llm = Qwen_API_Chat(model_name=args.model_name, temperature=args.temperature, max_new_tokens=args.max_new_tokens)
