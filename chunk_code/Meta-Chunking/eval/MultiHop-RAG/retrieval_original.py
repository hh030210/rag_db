...
from base_original import BaseRetriever
...
parser.add_argument('--save_file', default='toy_data/docs_original_corpus_nodie_top10.json', help="Path to the answer")
...
parser.add_argument('--collection_name', default="docs_original_corpus_nodie", help="Name of the collection")
...
# CUDA_VISIBLE_DEVICES=3 nohup python retrieval_original.py --construct_index >> docs_original_corpus_nodie_top10.log 2>&1 &