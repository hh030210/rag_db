...
def bleu_score(
    ...
    bleu = evaluate.load('CRUD/src/.cache/huggingface/bleu')
...
def rougeL_score(
    ...
    f = lambda text: list(jieba.cut(text))
    rouge = evaluate.load('CRUD/src/.cache/huggingface/rouge')
...
def bert_score(
    ...
    """
    sim = Similarity(model_name_or_path="BAAI/bge-large-en-v1.5")
