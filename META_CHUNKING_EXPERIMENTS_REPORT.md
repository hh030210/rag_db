...
| 任务 | 条件 | 有效结果数 | BLEU-avg | ROUGE-L | avg_length |
|---|---:|---:|---:|---:|---:|
| 1-doc | off | 3199 | 0.281 | 0.464 | 172.715 |
| 1-doc | on | 3198 | 0.302 | 0.485 | 171.809 |
| 2-doc | off | 3189 | 0.114 | 0.251 | 492.449 |
| 2-doc | on | 3189 | 0.125 | 0.278 | 494.511 |
| 3-doc | off | 3188 | 0.102 | 0.255 | 535.859 |
| 3-doc | on | 3188 | 0.118 | 0.273 | 535.453 |

`on - off` 差值为：

| 任务 | BLEU-avg | ROUGE-L | avg_length |
|---|---:|---:|---:|
| 1-doc | +0.021 | +0.021 | -0.906 |
| 2-doc | +0.011 | +0.027 | +2.062 |
| 3-doc | +0.016 | +0.018 | -0.406 |
