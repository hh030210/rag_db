...
class FileConversionUI:
    ...
    def create_ui(self) -> gr.Blocks:
        ...
        with gr.Blocks(title="文件转换与处理系统", theme=gr.themes.Soft(), css=custom_css) as app:
            gr.Markdown("""
            # 📄 文件转换与处理系统
...
def create_main_app():
    ...
    # 创建主应用
    with gr.Blocks(title="智能文档处理与RAG系统", theme=gr.themes.Soft(), css=custom_css) as main_app:
        ...
        chapter2_btn.click(
            ...
            outputs=[chapter2_container, chapter3_container, chapter2_btn, chapter3_btn, current_chapter]
        )
        ...
        add_docs_btn.click(
            fn=rag_page.add_documents_to_collection,
...
if __name__ == "__main__":
    ...
    app.launch(
        ...
        share=True  # 启用共享链接以解决localhost不可访问问题
    )
